...
BCHAR *TestABIContract_getIntArray(BoatEthTx *tx_ptr)
{
    BCHAR *call_result_str = NULL;
    BoatFieldVariable data_field = {NULL, 0};
    BCHAR *function_prototye_str;
...
BCHAR *TestABIContract_setString(BoatEthTx *tx_ptr, BCHAR*input)
{
    static BCHAR tx_hash_str[67] = "";
    BoatFieldVariable data_field = {NULL, 0};
    BCHAR *function_prototye_str;
...
BCHAR *TestABIContract_setUint32(BoatEthTx *tx_ptr, BUINT32 input)
{
    static BCHAR tx_hash_str[67] = "";
    BoatFieldVariable data_field = {NULL, 0};
    BCHAR *function_prototye_str;
