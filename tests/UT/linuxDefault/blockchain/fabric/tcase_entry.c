...
int main(int argc, char *argv[])
{
    ...
    Suite *suite_paramsInit  = make_fabricParamsTest_suite();
    Suite *suite_transaction = make_fabricTransactionTest_suite();
    ...
    srunner_set_log(sr, "test_FabricBlockchain_report.txt");
