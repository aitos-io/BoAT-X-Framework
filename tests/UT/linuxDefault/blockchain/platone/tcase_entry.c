...
int main(int argc, char *argv[])
{
    ...
    Suite *suite_walletInit  = make_platoneWalletTest_suite();
    Suite *suite_paramsInit  = make_platoneParamsTest_suite();
    Suite *suite_transaction = make_platoneTransactionTest_suite();
    ...
    sr = srunner_create(suite_walletInit);
    srunner_add_suite(sr, suite_paramsInit);
