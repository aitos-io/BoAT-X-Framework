...
BoatPlatoneNetworkConfig g_platone_network_config;

BoatKeypairPriKeyCtx_config get_platone_keypair_settings()
{
    ...
    else
    {
        ...
        g_keypair_config.prikey_content.field_ptr = (BUINT8 *)g_platone_private_key_buf;
        g_keypair_config.prikey_content.field_len = strlen(g_platone_private_key_buf) + 1;
    }
...
BOAT_RESULT check_platone_keypairCtx(BoatKeypairPriKeyCtx *keypair2Ctx, BUINT8 keypair1Index, BCHAR *keypair1Name, BoatKeypairPriKeyCtx_config *keypair1Config)
{
...
BOAT_RESULT check_platone_keypair_in_keypairList(BoatKeypairPriKeyCtx *keypair, BoatIotKeypairContext *keypair_list)
{
    BOAT_RESULT ret = BOAT_ERROR;
...
START_TEST(test_001Keypair_0001CreateOneTimeKeypairSuccessNullName)
{
    ...
    BoatIotSdkInit();
    /* 1. Create keypair1 */
    BoatKeypairPriKeyCtx_config keypair1_config = get_platone_keypair_settings();
    ...
    ret = check_platone_keypairCtx(&keypair2_ctx, keypair1_index, NULL, &keypair1_config);
    ck_assert(ret == BOAT_SUCCESS);
    ...
    ck_assert(ret == BOAT_SUCCESS);
    ret = check_platone_keypair_in_keypairList(&keypair2_ctx, &keypair_list);
    ck_assert(ret == BOAT_SUCCESS);
...
START_TEST(test_001Keypair_0002CreateOneTimeKeypairSuccessWithName)
{
    ...
    ret = check_platone_keypairCtx(&keypair2_ctx, keypair1_index, "oneTime_keypair", &keypair1_config);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
...
START_TEST(test_001Keypair_0003CreateOneTimeKeypairSuccessTwice)
{
    ...
    /* 2. Create keypair2 */
    BoatKeypairPriKeyCtx_config keypair2_config = get_platone_keypair_settings();
    ...
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypairCtx(&keypair_ctx, keypair2_index, "oneTime_keypair", &keypair2_config);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ...
    ret = BoATKeypair_GetKeypairList(&keypair_list);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypair_in_keypairList(&keypair_ctx, &keypair_list);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    /* free memory of keypair_name*/
...
START_TEST(test_001Keypair_0010CreatePersistKeypairSuccess)
{
    ...
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypairCtx(&keypair2_ctx, keypair1_index, "Persistkeypair1", &keypair1_config);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
...
START_TEST(test_001Keypair_0011Create2PersistKeypairSuccess)
{
    ...
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypairCtx(&keypair3_ctx, keypair1_index, "Persistkeypair1", &keypair1_config);
    ck_assert_int_eq(ret, BOAT_SUCCESS);

    keypair4_ctx.keypair_name = NULL;
    ret = BoATKeypair_GetKeypairByIndex(&keypair4_ctx, keypair2_index);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypairCtx(&keypair4_ctx, keypair2_index, "Persistkeypair2", &keypair2_config);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ...
    ret = check_platone_keypair_in_keypairList(&keypair3_ctx, &keypair_list);
    ck_assert_int_eq(ret, BOAT_SUCCESS);

    ret = check_platone_keypair_in_keypairList(&keypair4_ctx, &keypair_list);
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    /* free memory of keypair_name*/
...
START_TEST(test_001Keypair_0012DeleteOnetimeKeypairSuccess)
{
    ...
    ck_assert_int_eq(ret, BOAT_SUCCESS);
    ret = check_platone_keypair_in_keypairList(&keypair2_ctx, &keypair_list1);
