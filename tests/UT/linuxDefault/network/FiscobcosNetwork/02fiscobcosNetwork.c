...
****************************************************************************************
*/
static BOAT_RESULT getFiscobcosNetworkConfig(BoatFiscobcosNetworkConfig *config, BUINT8 networkIndex)
{
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
    ...
    /* get configuration */
    rtnVal = getFiscobcosNetworkConfig(&network_config, Index);
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0002CreateMoreOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatFiscobcosNetworkConfig network_config;
    ...
    {
        /* get configuration */
        rtnVal = getFiscobcosNetworkConfig(&network_config, i);
        ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
        /* create onetime network , store type must be RAM */
        rtnVal = BoATFiscobcosNetworkCreate(&network_config, BOAT_STORE_TYPE_RAM);
        /* check index of onetime network , the index must equal 0 */
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0003CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatFiscobcosNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0004CreateMorePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatFiscobcosNetworkConfig network_config;
    ...
    for (Index = 2; Index <= BOAT_MAX_NETWORK_NUM; Index++)
    {
        ...
        rtnVal = BoATFiscobcos_GetNetworkByIndex(&networkdata, Index);
        /* check the result of getting network data */
        ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : create persist fiscobcos network ;
*  created BOAT_MAX_NETWORK_NUM persist netsorks, can't create another persist network,
*  this case will return error.
* @return
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0005Create6PersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
    BoatFiscobcosNetworkConfig network_config;
...
****************************************************************************************
* @brief:
*  This function test case : get fiscobcos network list ;
*  created BOAT_MAX_NETWORK_NUM persist netsorks.
* @return
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0006GetNetworkListSuccess)
{
    BSINT32 rtnVal;
...
****************************************************************************************
* @brief:
*  This function test case : delete fiscobcos network which index equal 3 ;
* @return
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0007DeletePersistNetworkSuccess_index3)
{
    BSINT32 rtnVal;
    /* delete network*/
    rtnVal = BoATFiscobcosNetworkDelete(3);
    /* check the result */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0008GetNetworkListSuccess)
{
    BSINT32 rtnVal;
    BUINT8 index = 0;
    BoatFiscobcosNetworkContext networkList;
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0009CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 3;
    BoatFiscobcosNetworkConfig network_config;
    ...
    rtnVal = BoATFiscobcos_GetNetworkByIndex(&networkdata, 3);
    /* check the result of getting network data */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0010CreateOnetimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
    BoatFiscobcosNetworkConfig network_config;
...
****************************************************************************************
* @brief:
*  This function test case : get persist fiscobcos networks by index;
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0011GetNetworkByIndex)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatFiscobcosNetworkData networkdata;
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0012DeleteAllNetworkSuccess)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0013GetNetworkListSuccess)
{
    BSINT32 rtnVal;
    BUINT8 index = 0;
    BoatFiscobcosNetworkContext networkList;
...
****************************************************************************************
* @brief:
*  This function test case : create all the fiscobcos networks success;
*  create a onetime network and BOAT_MAX_NETWORK_NUM persist networks.
* @return
****************************************************************************************
*/
START_TEST(test_002fiscobcosNetwork_0014CreateAllNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatFiscobcosNetworkConfig network_config;
...
Suite *make_fiscobcosNetworkUtTest_suite(void)
{
    /* Create Suite */
    ...
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0002CreateMoreOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0003CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0004CreateMorePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0005Create6PersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0006GetNetworkListSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0007DeletePersistNetworkSuccess_index3);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0008GetNetworkListSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0009CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0010CreateOnetimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0011GetNetworkByIndex);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0012DeleteAllNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0013GetNetworkListSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0014CreateAllNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002fiscobcosNetwork_0012DeleteAllNetworkSuccess);
