...
****************************************************************************************
*/
static BOAT_RESULT getQuorumNetworkConfig(BoatQuorumNetworkConfig *config, BUINT8 networkIndex)
{
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0002CreateMoreOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatQuorumNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0003CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatQuorumNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0004CreateMorePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatQuorumNetworkConfig network_config;
    ...
    for (Index = 2; Index <= BOAT_MAX_NETWORK_NUM; Index++)
    {
        ...
        rtnVal = BoATQuorum_GetNetworkByIndex(&networkdata, Index);
        /* check the result of getting network data */
        ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : create persist quorum network ;
*  created BOAT_MAX_NETWORK_NUM persist netsorks, can't create another persist network,
*  this case will return error.
* @return
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0005Create6PersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
    BoatQuorumNetworkConfig network_config;
...
****************************************************************************************
* @brief:
*  This function test case : get quorum network list ;
*  created BOAT_MAX_NETWORK_NUM persist netsorks.
* @return
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0006GetNetworkListSuccess)
{
    BSINT32 rtnVal;
...
****************************************************************************************
* @brief:
*  This function test case : delete quorum network which index equal 3 ;
* @return
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0007DeletePersistNetworkSuccess_index3)
{
    BSINT32 rtnVal;
    /* delete network*/
    rtnVal = BoATQuorumNetworkDelete(3);
    /* check the result */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0008GetNetworkListSuccess)
{
    BSINT32 rtnVal;
    BUINT8 index = 0;
    BoatQuorumNetworkContext networkList;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0009CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 3;
    BoatQuorumNetworkConfig network_config;
    ...
    rtnVal = BoATQuorum_GetNetworkByIndex(&networkdata, 3);
    /* check the result of getting network data */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0010CreateOnetimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 0;
    BoatQuorumNetworkConfig network_config;
...
****************************************************************************************
* @brief:
*  This function test case : get persist quorum networks by index;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0011GetNetworkByIndex)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatQuorumNetworkData networkdata;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0012DeleteAllNetworkSuccess)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0013GetNetworkListSuccess)
{
    BSINT32 rtnVal;
    BUINT8 index = 0;
    BoatQuorumNetworkContext networkList;
...
****************************************************************************************
* @brief:
*  This function test case : create all the quorum networks success;
*  create a onetime network and BOAT_MAX_NETWORK_NUM persist networks.
* @return
****************************************************************************************
*/
START_TEST(test_002quorumNetwork_0014CreateAllNetworkSuccess)
{
    BSINT32 rtnVal;
    BUINT8 Index = 1;
    BoatQuorumNetworkConfig network_config;
...
Suite *make_quorumNetworkUtTest_suite(void)
{
    ...
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0002CreateMoreOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0003CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0004CreateMorePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0005Create6PersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0006GetNetworkListSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0007DeletePersistNetworkSuccess_index3);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0008GetNetworkListSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0009CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0010CreateOnetimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_002quorumNetwork_0011GetNetworkByIndex);
