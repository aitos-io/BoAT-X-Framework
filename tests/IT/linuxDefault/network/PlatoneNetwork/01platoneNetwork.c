...
****************************************************************************************
*/
BOAT_RESULT getPlatoneNetworkConfig(BoatPlatoneNetworkConfig *config, BUINT32 chainID, BBOOL eip155, BCHAR *url)
{
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkConfig network_config;
    BoatPlatoneNetworkData networkdata;
    /* get configuration */
    rtnVal = getPlatoneNetworkConfig(&network_config, chainID, BOAT_FALSE, demoUrl_1);
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0002CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkConfig network_config;
    BoatPlatoneNetworkData networkdata;
    /* get configuration */
    rtnVal = getPlatoneNetworkConfig(&network_config, chainID, BOAT_FALSE, demoUrl_2);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete onetime platone network success
* @return
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0003DeleteOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkConfig network_config;
    BoatPlatoneNetworkData networkdata;
    ...
    rtnVal = BoATPlatoneNetworkDelete(0);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete persist platone network success
* @return
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0004DeletePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkConfig network_config;
    BoatPlatoneNetworkData networkdata;
    ...
    ck_assert_int_eq(rtnVal, 1);
    /* delete the persist network */
    rtnVal = BoATPlatoneNetworkDelete(1);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete platone network;
*  There is no network, return error;
* @return
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0005DeleteNetwork_NoNetwork)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0006DeleteNetwork_IndexExceed)
{
    BSINT32 rtnVal;

    /* delete the network  */
    rtnVal = BoATPlatoneNetworkDelete(BOAT_MAX_NETWORK_NUM + 1);
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0007GetNetworkList_ParamNULL)
{
    BSINT32 rtnVal;

    /* get the network list */
    rtnVal = BoATPlatone_GetNetworkList(NULL);
    /* check the result */
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0008GetNetworkList_NONetwork)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0009GetNetworkList_OnlyOnetimeNetwork)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkContext networkList;
    BoatPlatoneNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0010GetNetworkList_OnetimeAndPersistNetwork)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkContext networkList;
    BoatPlatoneNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0011GetNetworkByIndex_ParamNULL)
{
    BSINT32 rtnVal;
    /* get network data by index , the first param set NULL */
    rtnVal = BoATPlatone_GetNetworkByIndex(NULL, 0);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_COMMON_INVALID_ARGUMENT);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0012GetNetworkByIndex_IndexExceed)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkData networkdata;
    /* get network data by index , but index bigger than BOAT_MAX_NETWORK_NUM */
    rtnVal = BoATPlatone_GetNetworkByIndex(&networkdata, BOAT_MAX_NETWORK_NUM + 1);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_NETWORK_INDEX_EXCEED);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0013GetNetworkByIndex_Onetime)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkData networkdata;
    BoatPlatoneNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platoneNetwork_0014GetNetworkByIndex_Persist)
{
    BSINT32 rtnVal;
    BoatPlatoneNetworkData networkdata;
    BoatPlatoneNetworkConfig network_config;
...
Suite *make_platoneNetworkIntfTest_suite(void)
{
    /* Create Suite */
    ...
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0002CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0003DeleteOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0004DeletePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0005DeleteNetwork_NoNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0006DeleteNetwork_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0007GetNetworkList_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0008GetNetworkList_NONetwork);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0009GetNetworkList_OnlyOnetimeNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0010GetNetworkList_OnetimeAndPersistNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0011GetNetworkByIndex_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0012GetNetworkByIndex_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0013GetNetworkByIndex_Onetime);
    tcase_add_test(tc_networkCreat_api, test_001platoneNetwork_0014GetNetworkByIndex_Persist);
