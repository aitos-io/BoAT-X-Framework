...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0002CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkConfig network_config;
    BoatVenachainNetworkData networkdata;
...
****************************************************************************************
* @brief:
*  This function test case : delete onetime venachain network success
* @return
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0003DeleteOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkConfig network_config;
    BoatVenachainNetworkData networkdata;
    ...
    rtnVal = BoATVenachainNetworkDelete(0);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete persist venachain network success
* @return
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0004DeletePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkConfig network_config;
    BoatVenachainNetworkData networkdata;
    ...
    ck_assert_int_eq(rtnVal, 1);
    /* delete the persist network */
    rtnVal = BoATVenachainNetworkDelete(1);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete venachain network;
*  There is no network, return error;
* @return
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0005DeleteNetwork_NoNetwork)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0006DeleteNetwork_IndexExceed)
{
    BSINT32 rtnVal;

    /* delete the network  */
    rtnVal = BoATVenachainNetworkDelete(BOAT_MAX_NETWORK_NUM + 1);
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0007GetNetworkList_ParamNULL)
{
    BSINT32 rtnVal;

    /* get the network list */
    rtnVal = BoATVenachain_GetNetworkList(NULL);
    /* check the result */
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0008GetNetworkList_NONetwork)
{
    BSINT32 rtnVal;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0009GetNetworkList_OnlyOnetimeNetwork)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkContext networkList;
    BoatVenachainNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0010GetNetworkList_OnetimeAndPersistNetwork)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkContext networkList;
    BoatVenachainNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0011GetNetworkByIndex_ParamNULL)
{
    BSINT32 rtnVal;
    /* get network data by index , the first param set NULL */
    rtnVal = BoATVenachain_GetNetworkByIndex(NULL, 0);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_COMMON_INVALID_ARGUMENT);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0012GetNetworkByIndex_IndexExceed)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkData networkdata;
    /* get network data by index , but index bigger than BOAT_MAX_NETWORK_NUM */
    rtnVal = BoATVenachain_GetNetworkByIndex(&networkdata, BOAT_MAX_NETWORK_NUM + 1);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_NETWORK_INDEX_EXCEED);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0013GetNetworkByIndex_Onetime)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkData networkdata;
    BoatVenachainNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001venachainNetwork_0014GetNetworkByIndex_Persist)
{
    BSINT32 rtnVal;
    BoatVenachainNetworkData networkdata;
    BoatVenachainNetworkConfig network_config;
...
Suite *make_venachainNetworkIntfTest_suite(void)
{
    ...
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0002CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0003DeleteOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0004DeletePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0005DeleteNetwork_NoNetwork);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0006DeleteNetwork_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0007GetNetworkList_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0008GetNetworkList_NONetwork);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0009GetNetworkList_OnlyOnetimeNetwork);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0010GetNetworkList_OnetimeAndPersistNetwork);
    tcase_add_test(tc_networkCreat_api, test_001venachainNetwork_0011GetNetworkByIndex_ParamNULL);
