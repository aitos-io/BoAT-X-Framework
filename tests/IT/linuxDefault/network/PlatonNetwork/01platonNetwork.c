...
****************************************************************************************
* @brief:
*  This function get the configuration to create platon network;
* @param[in/out] *config
...
****************************************************************************************
*/
BOAT_RESULT getPlatONNetworkConfig(BoatPlatONNetworkConfig *config, BUINT32 chainID, BBOOL eip155, BCHAR *url)
{
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    ...
    rtnVal = BoATPlatON_GetNetworkByIndex(&networkdata, 0);
...
****************************************************************************************
* @brief:
*  This function test case : create persist platon network success
*  index of persist netsorks is from 1 to BOAT_MAX_NETWORK_NUM
* @return
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0002CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkConfig network_config;
    BoatPlatONNetworkData networkdata;
    ...
    rtnVal = BoATPlatON_GetNetworkByIndex(&networkdata, 1);
    /* check the result of getting network data */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete onetime platon network success
* @return
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0003DeleteOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkConfig network_config;
    BoatPlatONNetworkData networkdata;
    ...
    rtnVal = BoATPlatONNetworkDelete(0);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete persist platon network success
* @return
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0004DeletePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkConfig network_config;
    BoatPlatONNetworkData networkdata;
    ...
    ck_assert_int_eq(rtnVal, 1);
    /* delete the persist network */
    rtnVal = BoATPlatONNetworkDelete(1);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete platon network;
*  There is no network, return error;
* @return
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0005DeleteNetwork_NoNetwork)
{
    BSINT32 rtnVal;
    for (size_t i = 0; i <= BOAT_MAX_NETWORK_NUM; i++)
    {
        /* delete the network  */
        rtnVal = BoATPlatONNetworkDelete(i);
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0006DeleteNetwork_IndexExceed)
{
    BSINT32 rtnVal;

    /* delete the network  */
    rtnVal = BoATPlatONNetworkDelete(BOAT_MAX_NETWORK_NUM + 1);
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0007GetNetworkList_ParamNULL)
{
    BSINT32 rtnVal;

    /* get the network list */
    rtnVal = BoATPlatON_GetNetworkList(NULL);
    /* check the result */
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0008GetNetworkList_NONetwork)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkContext networkList;
    /* get the network list */
    rtnVal = BoATPlatON_GetNetworkList(&networkList);
    /* check the result */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0009GetNetworkList_OnlyOnetimeNetwork)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkContext networkList;
    BoatPlatONNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0010GetNetworkList_OnetimeAndPersistNetwork)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkContext networkList;
    BoatPlatONNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0011GetNetworkByIndex_ParamNULL)
{
    BSINT32 rtnVal;
    /* get network data by index , the first param set NULL */
    rtnVal = BoATPlatON_GetNetworkByIndex(NULL, 0);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_COMMON_INVALID_ARGUMENT);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0012GetNetworkByIndex_IndexExceed)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkData networkdata;
    /* get network data by index , but index bigger than BOAT_MAX_NETWORK_NUM */
    rtnVal = BoATPlatON_GetNetworkByIndex(&networkdata, BOAT_MAX_NETWORK_NUM + 1);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_NETWORK_INDEX_EXCEED);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0013GetNetworkByIndex_Onetime)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkData networkdata;
    BoatPlatONNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001platonNetwork_0014GetNetworkByIndex_Persist)
{
    BSINT32 rtnVal;
    BoatPlatONNetworkData networkdata;
    BoatPlatONNetworkConfig network_config;
...
Suite *make_platonNetworkIntfTest_suite(void)
{
    /* Create Suite */
    ...
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0002CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0003DeleteOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0004DeletePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0005DeleteNetwork_NoNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0006DeleteNetwork_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0007GetNetworkList_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0008GetNetworkList_NONetwork);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0009GetNetworkList_OnlyOnetimeNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0010GetNetworkList_OnetimeAndPersistNetwork);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0011GetNetworkByIndex_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0012GetNetworkByIndex_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0013GetNetworkByIndex_Onetime);
    tcase_add_test(tc_networkCreat_api, test_001platonNetwork_0014GetNetworkByIndex_Persist);
