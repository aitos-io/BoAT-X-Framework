...
****************************************************************************************
*/
BOAT_RESULT getEthNetworkConfig(BoatEthNetworkConfig *config, BUINT32 chainID, BBOOL eip155, BCHAR *url)
{
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0001CreateOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatEthNetworkConfig network_config;
    BoatEthNetworkData networkdata;
    /* get configuration */
    rtnVal = getEthNetworkConfig(&network_config, chainID, BOAT_FALSE, demoUrl_1);
    ...
    rtnVal = BoATEth_GetNetworkByIndex(&networkdata, 0);
...
****************************************************************************************
* @brief:
*  This function test case : create persist eth network success
*  index of persist netsorks is from 1 to BOAT_MAX_NETWORK_NUM
* @return
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0002CreatePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatEthNetworkConfig network_config;
    BoatEthNetworkData networkdata;
    /* get configuration */
    rtnVal = getEthNetworkConfig(&network_config, chainID, BOAT_FALSE, demoUrl_2);
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
    /* create persist network , store type must be FLASH */
    rtnVal = BoATEthNetworkCreate(&network_config, BOAT_STORE_TYPE_FLASH);
    ...
    rtnVal = BoATEth_GetNetworkByIndex(&networkdata, 1);
    /* check the result of getting network data */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
* @brief:
*  This function test case : delete onetime eth network success
* @return
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0003DeleteOneTimeNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatEthNetworkConfig network_config;
    BoatEthNetworkData networkdata;
...
****************************************************************************************
* @brief:
*  This function test case : delete persist eth network success
* @return
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0004DeletePersistNetworkSuccess)
{
    BSINT32 rtnVal;
    BoatEthNetworkConfig network_config;
    BoatEthNetworkData networkdata;
...
****************************************************************************************
* @brief:
*  This function test case : delete eth network;
*  There is no network, return error;
* @return
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0005DeleteNetwork_NoNetwork)
{
    BSINT32 rtnVal;
    for (size_t i = 0; i <= BOAT_MAX_NETWORK_NUM; i++)
    {
        /* delete the network  */
        rtnVal = BoATEthNetworkDelete(i);
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0006DeleteNetwork_IndexExceed)
{
    BSINT32 rtnVal;

    /* delete the network  */
    rtnVal = BoATEthNetworkDelete(BOAT_MAX_NETWORK_NUM + 1);
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0007GetNetworkList_ParamNULL)
{
    BSINT32 rtnVal;

    /* get the network list */
    rtnVal = BoATEth_GetNetworkList(NULL);
    /* check the result */
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0008GetNetworkList_NONetwork)
{
    BSINT32 rtnVal;
    BoatEthNetworkContext networkList;
    /* get the network list */
    rtnVal = BoATEth_GetNetworkList(&networkList);
    /* check the result */
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0009GetNetworkList_OnlyOnetimeNetwork)
{
    BSINT32 rtnVal;
    BoatEthNetworkContext networkList;
    BoatEthNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0010GetNetworkList_OnetimeAndPersistNetwork)
{
    BSINT32 rtnVal;
    BoatEthNetworkContext networkList;
    BoatEthNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0011GetNetworkByIndex_ParamNULL)
{
    BSINT32 rtnVal;
    /* get network data by index , the first param set NULL */
    rtnVal = BoATEth_GetNetworkByIndex(NULL, 0);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_COMMON_INVALID_ARGUMENT);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0012GetNetworkByIndex_IndexExceed)
{
    BSINT32 rtnVal;
    BoatEthNetworkData networkdata;
    /* get network data by index , but index bigger than BOAT_MAX_NETWORK_NUM */
    rtnVal = BoATEth_GetNetworkByIndex(&networkdata, BOAT_MAX_NETWORK_NUM + 1);
    /* check result*/
    ck_assert_int_eq(rtnVal, BOAT_ERROR_NETWORK_INDEX_EXCEED);
}
END_TEST
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0013GetNetworkByIndex_Onetime)
{
    BSINT32 rtnVal;
    BoatEthNetworkData networkdata;
    BoatEthNetworkConfig network_config;
...
****************************************************************************************
*/
START_TEST(test_001ethNetwork_0014GetNetworkByIndex_Persist)
{
    BSINT32 rtnVal;
    BoatEthNetworkData networkdata;
    BoatEthNetworkConfig network_config;
...
Suite *make_ethNetworkIntfTest_suite(void)
{
    /* Create Suite */
    ...
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0001CreateOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0002CreatePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0003DeleteOneTimeNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0004DeletePersistNetworkSuccess);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0005DeleteNetwork_NoNetwork);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0006DeleteNetwork_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0007GetNetworkList_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0008GetNetworkList_NONetwork);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0009GetNetworkList_OnlyOnetimeNetwork);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0010GetNetworkList_OnetimeAndPersistNetwork);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0011GetNetworkByIndex_ParamNULL);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0012GetNetworkByIndex_IndexExceed);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0013GetNetworkByIndex_Onetime);
    tcase_add_test(tc_networkCreat_api, test_001ethNetwork_0014GetNetworkByIndex_Persist);
