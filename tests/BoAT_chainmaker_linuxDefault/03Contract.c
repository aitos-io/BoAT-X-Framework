...
START_TEST(test_03Contract_0006InvokeSucessSyncOn) 
{
    BOAT_RESULT        result;
    BoatHlchainmakerTx tx_ptr;
    BoatInvokeResponse  invoke_response;
...
START_TEST(test_03Contract_0007InvokeSucessSyncOff) 
{
    BOAT_RESULT        result;
    BoatHlchainmakerTx tx_ptr;
    BoatInvokeResponse  invoke_response;
...
START_TEST(test_03Contract_0009QueryFailureMethodNull) 
{
    BOAT_RESULT        result;
    BoatHlchainmakerTx tx_ptr;
    BoatQueryResponse  query_response;
...
START_TEST(test_03Contract_00012InvokeFailureResponseNull) 
{
    BOAT_RESULT        result;
    BoatHlchainmakerTx tx_ptr;
...
START_TEST(test_03Contract_00013InvokeSucess) 
{
   BOAT_RESULT        result;
    BoatHlchainmakerTx tx_ptr;
    BoatQueryResponse  query_response;
...
Suite *make_contract_suite(void) 
{
    ...
    tcase_add_test(tc_contract_api, test_03Contract_00012InvokeFailureResponseNull);
    tcase_add_test(tc_contract_api, test_03Contract_00013InvokeSucess);
