...
START_TEST(test_003NodesDiscover_0010Discover_Fail_ChaincodeID_name_ERR) 
{
    BSINT32 rtnVal;
    BoatHlfabricTx tx_ptr;
    BoatHlfabricWallet *g_fabric_wallet_ptr = NULL;
    ...
    g_fabric_wallet_ptr = BoatGetWalletByIndex(rtnVal);
    ck_assert(g_fabric_wallet_ptr != NULL);
    rtnVal = BoatHlfabricTxInit(&tx_ptr, g_fabric_wallet_ptr, NULL, "mycc11", NULL, "mychannel", "Org1MSP");
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
    long int timesec = 0;
	time(&timesec);
	rtnVal = BoatHlfabricTxSetTimestamp(&tx_ptr, timesec, 0);
...
START_TEST(test_003NodesDiscover_0011Discover_Fail_ChainID_ERR) 
{
    BSINT32 rtnVal;
    BoatHlfabricTx tx_ptr;
    BoatHlfabricWallet *g_fabric_wallet_ptr = NULL;
    ...
    g_fabric_wallet_ptr = BoatGetWalletByIndex(rtnVal);
    ck_assert(g_fabric_wallet_ptr != NULL);
    rtnVal = BoatHlfabricTxInit(&tx_ptr, g_fabric_wallet_ptr, NULL, "mycc", NULL, "mychannel11", "Org1MSP");
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
    long int timesec = 0;
	time(&timesec);
	rtnVal = BoatHlfabricTxSetTimestamp(&tx_ptr, timesec, 0);
...
START_TEST(test_003NodesDiscover_0012Discover_Fail_orgName_ERR) 
{
    BSINT32 rtnVal;
    BoatHlfabricTx tx_ptr;
    BoatHlfabricWallet *g_fabric_wallet_ptr = NULL;
    ...
    g_fabric_wallet_ptr = BoatGetWalletByIndex(rtnVal);
    ck_assert(g_fabric_wallet_ptr != NULL);
    rtnVal = BoatHlfabricTxInit(&tx_ptr, g_fabric_wallet_ptr, NULL, "mycc", NULL, "mychannel", "Org1MSP11");
    ck_assert_int_eq(rtnVal, BOAT_SUCCESS);
    long int timesec = 0;
	time(&timesec);
	rtnVal = BoatHlfabricTxSetTimestamp(&tx_ptr, timesec, 0);
...
Suite *make_nodesDiscover_suite(void) 
{
    ...
    tcase_add_test(tc_nodesDiscover_api, test_003NodesDiscover_0011Discover_Fail_ChainID_ERR);
    tcase_add_test(tc_nodesDiscover_api, test_003NodesDiscover_0012Discover_Fail_orgName_ERR);
