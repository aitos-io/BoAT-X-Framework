 ...
 *
 * EIP-155 (https://github.com/Quorum/EIPs/blob/master/EIPS/eip-155.md) requires
 ...
 */
typedef struct TBoatQuorumNetworkInfo
{
...
typedef struct TBoatQuorumWallet
{
    ...
    BoatQuorumNetworkInfo network_info; //!< Network information
...
/*!****************************************************************************
 * @brief Initialize Boat Quorum Wallet
 *
 * @details
 *   This function sets up context of Boat Quorum Wallet based on given
 *   configuration.
 *   \n DO NOT call this function directly. Instead call BoatWalletCreate() with an Quorum
 *   wallet configuration like:
 *   @verbatim
     BoatQuorumWalletConfig Quorum_config = {...};
     BSINT32 wallet_index;
     wallet_index = BoatWalletCreate(BOAT_PROTOCOL_QuorumEREUM,
                                     &Quorum_config,
                                     sizeof(BoatQuorumWalletConfig)
                                    );
     @endverbatim
 ...
 *   
 * @param[in] config_ptr
 *   Pointer to Quorum wallet configuration.
 *
 * @param[in] config_size
 *   Size (in byte) of Quorum wallet configuration.
 *
 * @return
 *   This function returns instance pointer of BoatQuorumWallet if initialization is successful.\n
 *   Otherwise it returns NULL.
 *      
 * @see BoatQuorumWalletDeInit() BoatWalletCreate()
 ******************************************************************************/
 ...
 *   Otherwise it returns one of the error codes.      
 ******************************************************************************/
BOAT_RESULT BoatQuorumWalletSetEIP155Comp(BoatQuorumWallet *wallet_ptr, BBOOL eip155_compatibility);
