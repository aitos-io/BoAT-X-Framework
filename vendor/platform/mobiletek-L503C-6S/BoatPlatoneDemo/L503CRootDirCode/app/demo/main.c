...
static int waitforNetwork(void){
	...
	{
		user_app_printf("ol_wait_network_regist time out\n");
		return -1;
	}
	user_app_printf("execute ol_data_call_start \n");
	...
	{
		user_app_printf("ol_data_call_start fail\n");
		return -1;
	}
