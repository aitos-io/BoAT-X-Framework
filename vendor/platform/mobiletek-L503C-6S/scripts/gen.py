...
class ConfigContentGen():
    ...
    def gen_config_content(self):
        self.config_content += '\n'
        self.config_content += '#define  RPC_USE_OLHTTPPORT     1'
        self.config_content += '\n'

    def gen_config_file_content(self):
        self.config_content += '\n'
        self.config_content += '#define  BOAT_USE_MOBILETEK_FILESYSTEM     1'
        self.config_content += '\n'
...
def main():
    ...
    configContent_obj.gen_config_file_content()
