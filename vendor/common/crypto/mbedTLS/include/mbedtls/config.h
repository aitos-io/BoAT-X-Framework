...
#define MBEDTLS_PLATFORM_CALLOC_MACRO           BoatCalloc /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO             BoatFree /**< Default free macro to use, can be undefined */
