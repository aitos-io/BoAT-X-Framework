...
#pragma warning(default : 4324)
    ...
    AES_RETURN default_aes_init(void);
    ...
    AES_RETURN default_aes_encrypt(const unsigned char *in, unsigned char *out, const aes_encrypt_ctx cx[1]);
    ...
    AES_RETURN default_aes_decrypt(const unsigned char *in, unsigned char *out, const aes_decrypt_ctx cx[1]);
