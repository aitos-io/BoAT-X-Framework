...
typedef struct _Common__AliasInfo Common__AliasInfo;
typedef struct _Common__AliasInfos Common__AliasInfos;
typedef struct _Common__AliasCertInfo Common__AliasCertInfo;
...
typedef enum _Common__TxStatusCode {
  ...
  COMMON__TX_STATUS_CODE__GAS_BALANCE_NOT_ENOUGH_FAILED = 42,
  COMMON__TX_STATUS_CODE__GAS_LIMIT_NOT_SET = 43
...
#define COMMON__TX_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__tx_response__descriptor) \
    , COMMON__TX_STATUS_CODE__SUCCESS, (char *)protobuf_c_empty_string, NULL, (char *)protobuf_c_empty_string, 0, 0 }
...
#define COMMON__RESULT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__result__descriptor) \
    , COMMON__TX_STATUS_CODE__SUCCESS, NULL, {0,NULL}, (char *)protobuf_c_empty_string }
...
#define COMMON__CONTRACT_RESULT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__contract_result__descriptor) \
    , 0, {0,NULL}, (char *)protobuf_c_empty_string, 0, 0,NULL }
...
#define COMMON__CONTRACT_EVENT_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__contract_event_info__descriptor) \
    , 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0,NULL }
 ...
 * alias info
 */
struct  _Common__AliasInfo
{
  ProtobufCMessage base;
  char *alias;
  Common__AliasCertInfo *now_cert;
  size_t n_his_certs;
  Common__AliasCertInfo **his_certs;
};
#define COMMON__ALIAS_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__alias_info__descriptor) \
 ...
 * alias info
 */
struct  _Common__AliasInfos
{
  ProtobufCMessage base;
  size_t n_alias_infos;
  Common__AliasInfo **alias_infos;
};
#define COMMON__ALIAS_INFOS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__alias_infos__descriptor) \
    , 0,NULL }
...
#define COMMON__ALIAS_CERT_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&common__alias_cert_info__descriptor) \
...
typedef void (*Common__ContractEventInfoList_Closure)
                 (const Common__ContractEventInfoList *message,
                  void *closure_data);
typedef void (*Common__AliasInfo_Closure)
                 (const Common__AliasInfo *message,
                  void *closure_data);
typedef void (*Common__AliasInfos_Closure)
                 (const Common__AliasInfos *message,
                  void *closure_data);
typedef void (*Common__AliasCertInfo_Closure)
                 (const Common__AliasCertInfo *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor common__alias_info__descriptor;
extern const ProtobufCMessageDescriptor common__alias_infos__descriptor;
extern const ProtobufCMessageDescriptor common__alias_cert_info__descriptor;
