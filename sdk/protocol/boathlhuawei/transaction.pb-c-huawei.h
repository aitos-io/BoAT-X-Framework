...
typedef enum _Common__TxStatus_huawei {
  COMMON__STATUS__HUAWEI__VALID = 0,
  COMMON__STATUS__HUAWEI__INVALID_TX_PAYLOAD = 1,
  COMMON__STATUS__HUAWEI__INVALID_TX_HEADER = 2,
  COMMON__STATUS__HUAWEI__INVALID_TX_TYPE = 3,
  COMMON__STATUS__HUAWEI__UNKNOWN_TX_TYPE = 4,
  COMMON__STATUS__HUAWEI__DUPLICATE_TX = 5,
  COMMON__STATUS__HUAWEI__INVALID_STATE_UPDATES_TYPE = 6,
  COMMON__STATUS__HUAWEI__INVALID_INSERT_STATEMENTS = 7,
  COMMON__STATUS__HUAWEI__INVALID_SELECT_STATEMENTS = 8,
  COMMON__STATUS__HUAWEI__INVALID_SQL_SYNTAX = 9,
  COMMON__STATUS__HUAWEI__INVALID_SQL_SCHEMA = 10,
  COMMON__STATUS__HUAWEI__INVALID_COMMON_TX_DATA = 11,
  COMMON__STATUS__HUAWEI__INVALID_VOTE_TX_DATA = 12,
  COMMON__STATUS__HUAWEI__INVALID_CHAIN_CONFIG = 13,
  COMMON__STATUS__HUAWEI__INVALID_ARCHIVE_TX_DATA = 14,
  COMMON__STATUS__HUAWEI__INVALID_CONTRACT_INVOCATION = 21,
  COMMON__STATUS__HUAWEI__INVALID_APPROVAL_SIGNATURE = 22,
  COMMON__STATUS__HUAWEI__APPROVALS_VALIDATION_FAILURE = 23,
  COMMON__STATUS__HUAWEI__UNKNOWN_VOTE_HANDLER = 31,
  COMMON__STATUS__HUAWEI__INVALID_VOTE_PAYLOAD = 32,
  COMMON__STATUS__HUAWEI__INVALID_MVCC = 41,
  COMMON__STATUS__HUAWEI__CONTRACT_ALREADY_INIT = 42,
  COMMON__STATUS__HUAWEI__CONTRACT_NOT_INIT = 43,
  COMMON__STATUS__HUAWEI__INVALID_LATEST_BLOCK = 44,
  COMMON__STATUS__HUAWEI__INVALID = 255
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(COMMON__TX_STATUS)
} Common__TxStatus_huawei;
