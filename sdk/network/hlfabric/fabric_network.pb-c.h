...
typedef struct Common__FabricNetworks Common__FabricNetworks;
typedef struct Common__FabricNetworkData Common__FabricNetworkData;
typedef struct Common__FabricNodesCfg Common__FabricNodesCfg;
typedef struct Common__FabricNodeLayoutCfg Common__FabricNodeLayoutCfg;
typedef struct Common__FabricNodeGroupCfg Common__FabricNodeGroupCfg;
typedef struct Common__FabricNodeInfo Common__FabricNodeInfo;
...
struct  Common__FabricNetworkData
{
  ProtobufCMessage base;
  uint32_t index;
...
struct  Common__FabricNodeLayoutCfg
{
  ProtobufCMessage base;
  /*
   * uint32 groupNum = 1;
...
struct  Common__FabricNodeGroupCfg
{
  ProtobufCMessage base;
  uint32_t quantities;
  /*
